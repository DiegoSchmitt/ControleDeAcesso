...
<body>
    ...
    <nav>
        ...
        <ul class="menu">
            ...
            <li><a href="forms/addAdmin.php">Adicionar novo administrador</a></li>
            ...
            <li id="edit_adm_name">
                ...
                <form action="filters/filterByNameAdmin.php" id="edit_form_adm_name" class="form_adm_menu" method="post">
                    <input type="text" name="filter_name_admin" placeholder="digite o nome">
                    <input type="submit" value="Buscar">
                </form>
            </li>
            <li id="edit_adm_id">
                ...
                <form action="filters/filterByIdAccessAdmin.php" id="edit_form_adm_id" class="form_adm_menu" method="post">
                    <input type="text" name="filter_id_access" placeholder="digite o id">
                    <input type="submit" value="Buscar">
                </form>
            </li>
            <li id="edit_adm_email">
                ...
                <form action="filters/filterByEmailAdmin.php" id="edit_form_adm_email" class="form_adm_menu" method="post">
                    <input type="text" name="filter_email_admin" placeholder="digite o email">
                    <input type="submit" value="Buscar">
                </form>
            </li>
            </ul>    
