    ...
    <nav>
        ...
        <ul class="menu">
            <li>
                ...
                <a href="forms/addUser.php">Adicionar novo usuário</a>
            </li>
            <li id="alter_user">
                <span class="material-symbols-outlined">
                    edit
                ...
                <ul class="sub_menu">
                    ...
                    <li id="edit_user_email">
                        ...
                        <form action="filters/filterByEmailUser.php" id="edit_form_email" class="form_menu" method="POST">
                            <input type="text" name="filter_email_user" id="filter_email_user" class="filter-input" placeholder="digite o email">
                            <input type="submit" class="btn-filter" value="Buscar">
                        </form>
                    </li>
                </ul>     
